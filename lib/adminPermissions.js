/** @typedef {{ usersView: boolean; usersCreate: boolean; usersEdit: boolean; usersDelete: boolean; walletsView: boolean; walletsAdjust: boolean, manageTokens: boolean }} AdminPermissionsShape */
