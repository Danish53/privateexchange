...
export function serializeMembershipTier(doc) {
  ...
  return {
    ...
    benefits,
    transfer_fee: Boolean(d.transferFee),
    vip_drawings: Boolean(d.vipDrawings),
    executive_events: Boolean(d.executiveEvents),
    priority_support: Boolean(d.prioritySupport),
