...
const UserSchema = new mongoose.Schema(
  {
    ...
    adminPermissions: {
      ...
      manageTokens: { type: Boolean, default: false },
      transactionsView: { type: Boolean, default: false },
      drawingsManage: { type: Boolean, default: false },
      membershipManage: { type: Boolean, default: false },
      announcementsManage: { type: Boolean, default: false },
      supportTicketsManage: { type: Boolean, default: false },
    },
  },
  { timestamps: true }
);
