...
/**
 * Append-only ledger line per proposal: deposits, buys, transfers, fees, admin credits/debits.
...
const LedgerEntrySchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      required: true,
      enum: ['deposit', 'withdrawal', 'buy', 'transfer', 'fee', 'admin_credit', 'admin_debit'],
      index: true,
    },
    /** Token code e.g. USD, Cristalino, Raffle */
...
if (process.env.NODE_ENV !== 'production' && mongoose.models.LedgerEntry) {
