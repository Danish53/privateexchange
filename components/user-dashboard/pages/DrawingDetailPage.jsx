    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <article className="rounded-2xl border border-white/[0.08] bg-gradient-to-br from-black/[0.35] to-[#07080c] p-6 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)]">
          ...
          {drawing.prize_image ? (
            <div className="mt-5 w-fit overflow-hidden rounded-xl border border-white/[0.08] bg-black/25 h-56">
          ...
          {drawing.prize_description ? (
            <div className="mt-4 rounded-xl border border-white/[0.08] bg-black/25 p-4">
              ...
              <p className="mt-2 text-sm leading-relaxed text-brand-muted">{drawing.prize_description}</p>
            </div>
          ) : null}
